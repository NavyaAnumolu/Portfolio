      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            •	Full stack .Net Developer with 5+ years of experience specializing in the development of scalable and reliable backend systems. Strong background in data structures, algorithms, and cloud solutions. Adept in CI/CD practices, version control, and Agile methodologies, ensuring efficient project execution and high-quality software delivery.
            <br />
            <br />
